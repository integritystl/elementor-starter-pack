            ...
            <div v-else class="sui-field-list sui-flushed no-border">
                <div class="sui-field-list-body">
                    ...
                    <div class="sui-field-list-item">
                        ...
                        <a :href="campaign_url('defender_dash_filescan_pro_tag')" target="_blank" class="sui-button sui-button-purple sui-tooltip" data-tooltip="Try Defender Pro free today">
                            {{__("Pro Feature")}}
                        </a>
                    </div>
                    <div class="sui-field-list-item">
